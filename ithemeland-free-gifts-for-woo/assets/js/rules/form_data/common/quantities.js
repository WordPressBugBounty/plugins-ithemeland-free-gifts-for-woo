...
jQuery(document).ready(function ($) {
  $(document).on("click", ".wgbl-bulk-quantity-quantities-add-item", function () {
    ...
    if (WGBL_RULES_DATA.quantities.bulk_quantity.row) {
      rule
        .find(".wgbl-rule-quantities-bulk-quantity-repeatable-items")
  ...
  $(document).on("click", ".wgbl-bulk-pricing-quantities-add-item", function () {
    ...
    if (WGBL_RULES_DATA.quantities.bulk_pricing.row) {
      rule
        .find(".wgbl-rule-quantities-bulk-pricing-repeatable-items")
  ...
  $(document).on("click", ".wgbl-tiered-quantities-add-item", function () {
    ...
    if (WGBL_RULES_DATA.quantities.tiered_quantity.row) {
      rule
        .find(".wgbl-rule-quantities-tiered-quantity-repeatable-items")
  ...
  $(document).on("click", ".wgbl-rules-quantities-bulk-quantity-delete-row-item", function () {
    let rule = $(this).closest(".wgbl-rule-item");
    $(this)
      .closest(".wgbl-rule-quantities-bulk-quantity-repeatable-item")
      .remove()
      .ready(function () {
        wgblBulkQuantityFixPriority(rule);
      });
  ...
  $(document).on("click", ".wgbl-rules-quantities-bulk-pricing-delete-row-item", function () {
    let rule = $(this).closest(".wgbl-rule-item");
    $(this)
      .closest(".wgbl-rule-quantities-bulk-pricing-repeatable-item")
      .remove()
      .ready(function () {
        wgblBulkQuantityFixPriority(rule);
      });
  ...
  $(document).on("click", ".wgbl-rules-quantities-tiered-quantity-delete-row-item", function () {
    let rule = $(this).closest(".wgbl-rule-item");
    $(this)
      .closest(".wgbl-rule-quantities-tiered-quantity-repeatable-item")
      .remove()
      .ready(function () {
        wgblBulkQuantityFixPriority(rule);
      });
...
function wgblRuleSimpleQuantities(ruleID) {
  ...
  wgblDisableGeneralQuantitiesItem(ruleID, ["quantities-subtotal-amount", "quantities-apply-on-cart-item", "quantities-buy"]);
}

function wgblRuleCheapestItemInCartQuantities(ruleID) {
  wgblRuleEnableQuantities(ruleID);
  wgblDisableGeneralQuantitiesItem(ruleID, ["quantities-subtotal-amount", "quantities-auto-add-gift-to-cart", "quantities-same-gift", "quantities-get"]);
}

function wgblRuleFreeShippingQuantities(ruleID) {
  wgblRuleEnableQuantities(ruleID);
}

function wgblRuleBuyXGetXQuantities(ruleID) {
  wgblRuleEnableQuantities(ruleID);
  wgblDisableGeneralQuantitiesItem(ruleID, ["quantities-subtotal-amount", "quantities-apply-on-cart-item"]);
}
...
function wgblRuleSubTotalQuantities(ruleID) {
  wgblRuleEnableQuantities(ruleID);
  wgblDisableGeneralQuantitiesItem(ruleID, ["quantities-buy", "quantities-apply-on-cart-item"]);
}
...
function wgblRuleEnableQuantities(ruleID) {
  let method = jQuery(".wgbl-rule-item[data-id=" + ruleID + "]")
    .find(".wgbl-rule-method")
    .val();
  switch (method) {
    case "bulk_quantity":
      ...
      wgblRuleDisableFreeShippingQuantities(ruleID);
      break;
    case "bulk_pricing":
      wgblRuleDisableGeneralQuantities(ruleID);
    ...
    case "free_shipping":
      ...
      wgblRuleDisableBulkQuantityQuantities(ruleID);
      wgblRuleDisableGeneralQuantities(ruleID);
      wgblRuleEnableFreeShippingQuantities(ruleID);
      break;
    default:
      wgblRuleDisableBulkPricingQuantities(ruleID);
      wgblRuleDisableTieredQuantities(ruleID);
...
function wgblRuleEnableFreeShippingQuantities(ruleID) {
  let generalQuantities = jQuery(".wgbl-rule-item[data-id=" + ruleID + '] div[data-method-type="free_shipping"]');
  generalQuantities.find("select").prop("disabled", false);
  generalQuantities.find("input").prop("disabled", false);
  generalQuantities.show();
}

function wgblRuleDisableFreeShippingQuantities(ruleID) {
  let generalQuantities = jQuery(".wgbl-rule-item[data-id=" + ruleID + '] div[data-method-type="free_shipping"]');
  generalQuantities.find("select").prop("disabled", true);
  generalQuantities.find("input").prop("disabled", true);
  generalQuantities.hide();
