...
class Order
{
    ...
    {
        $first_order = $this->wpdb->get_row("SELECT post_date FROM {$this->wpdb->posts} WHERE post_type = 'shop_order' ORDER BY ID ASC LIMIT 1", ARRAY_A); //phpcs:ignore
