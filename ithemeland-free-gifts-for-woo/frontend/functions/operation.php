...
function itfreegift_check_basic_operations($option_key, $value, $condition_value)
{
...
function itfreegift_check_advanced_operations($option_key, $value, $condition_value)
{
    //die;
    // Check if field values support hierarchy, e.g. product categories that may have child categories
    $hierarchy_support = itfreegift_array_is_multidimensional($condition_value);
...
function itfreegift_check_simple_operations($option_key, $value, $condition_value)
{
    // Normalize value
    $value = (array) $value;
    $value = array_map('strval', $value);
    ...
    if (itfreegift_array_is_multidimensional($condition_value)) {
...
function itfreegift_check_datetime_operations($option_key, $value, $condition_value)
{

    //itfreegift_date_create_from_format_fUnction
    // Get condition date

    //	if ( $condition_date = itfreegift_get_datetime( $option_key, $condition_value ) ) {
