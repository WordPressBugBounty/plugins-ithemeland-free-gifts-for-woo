			...
			<div class="pw_gift_pagination_div wgb-item-layout2">
				...
				?>
						<div class="page_<?php echo esc_attr($page); ?> pw_gift_pagination_div <?php echo esc_attr($active); ?> wgb-item-layout2">
							...
							?>
							<div class="<?php echo esc_attr($settings['desktop_columns']); ?> <?php echo esc_attr($settings['tablet_columns']); ?> <?php echo esc_attr($settings['mobile_columns']); ?> <?php echo esc_attr($i); ?>">
						...
						if (($i == $settings['number_per_page'] ||  $count_items == $t) && $paginition_type == 'number') {
							//$insert_div  = false;
							echo '</div></div>';
							$i = 0;
							$page++;
						...
						?>
							<div class="wgb-pagination-cnt">
								<input type="hidden" id="wgb-cart-pagination-max-num-pages" vaue="<?php echo esc_attr($max_num_pages); ?>">
