...
<div class="wgb-list-items">
    ...
    ?>
        <div class="wgb-list-item <?php echo esc_attr(implode(' ', $link_classes)); ?>">
            <div class="wgb-list-item-thumb">
                ...
                <?php if ($settings['show_stock_quantity'] == 'true') : ?>
                    <div class="wgb-stock">
                        <div class="gift-product-stock"><?php itg_render_stock_status($gift_product['stock_qty'], $settings, $gift_product, true); ?></div>
                    </div>
                <?php endif; ?>
            </div>
