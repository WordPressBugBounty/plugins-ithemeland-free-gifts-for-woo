...
include WGBL_VIEWS_DIR . "layout/header.php"; ?>
<div id="wgb-body">
            ...
            <div class="wgb-tab-content-item" data-content="rules">
                <div class="wgb-wrap">
                    <div class="wgb-tab-middle-content">
                        ...
                        ?>
                        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST" id="wgb-offer-rules-form">
                            <?php wp_nonce_field('wgb_post_nonce'); ?>
                            <input type="hidden" name="action" value="wgb_save_offer_rules">
                            <div id="wgb-offer-rules">
                            ...
                            <div class="wgb-col-12" style="padding: 0 !important;">
                                <p class="wgb-empty-rules-box" style="<?php echo (!empty($rules['items'])) ? 'display:none' : ''; ?>"><?php esc_html_e("No offer configured.", 'ithemeland-free-gifts-for-woo'); ?></p>
                                <button type="button" class="wgb-button wgb-button-white-green wgb-float-right wgb-add-offer-rule wgb-mt10" style="margin-right: 0 !important;"><?php esc_html_e("Add Offer", 'ithemeland-free-gifts-for-woo'); ?></button>
                                <button type="button" class="wgb-button wgb-button-blue wgb-float-left wgb-mt10" id="wgb-offer-rules-save-changes"><?php esc_html_e("Save Changes", 'ithemeland-free-gifts-for-woo'); ?></button>
                            </div>
