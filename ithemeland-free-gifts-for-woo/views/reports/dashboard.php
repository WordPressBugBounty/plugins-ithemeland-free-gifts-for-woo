    ...
    <div class="wgbl-tab-middle-content wgbl-skeleton">
            ...
            <div class="wgbl-col-3">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-top-boxes">
                    ...
                    <div class="wgbl-boxes-text">
                        ...
                        <div class="wgbl-widget-subtitle"><span><?php esc_html_e('Total Gifts No.', 'ithemeland-free-gifts-for-woo'); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="wgbl-col-3">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-top-boxes">
                    ...
                    <div class="wgbl-boxes-text">
                        ...
                        <div class="wgbl-widget-subtitle"><span><?php esc_html_e('Total Customers No.', 'ithemeland-free-gifts-for-woo'); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="wgbl-col-3">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-top-boxes">
                    ...
                    <div class="wgbl-boxes-text">
                        ...
                        <div class="wgbl-widget-subtitle"><span><?php esc_html_e('Used Rule No.', 'ithemeland-free-gifts-for-woo'); ?></span></div>
                    </div>
                </div>
            </div>
            <div class="wgbl-col-3">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-top-boxes">
                    ...
                    <div class="wgbl-boxes-text">
                        ...
                        <div class="wgbl-widget-subtitle"><span><?php esc_html_e('Orders No.', 'ithemeland-free-gifts-for-woo'); ?></span></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wgbl-row">
            <div class="wgbl-col-12">
                <strong class="wgbl-section-title"><?php esc_html_e('Recent 10 orders used the gift', 'ithemeland-free-gifts-for-woo'); ?></strong>
            </div>
            <div class="wgbl-col-12">
        ...
        <div class="wgbl-row">
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 methods', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
            ...
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 rules', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table wgbl-mini-data-grid-box">
                    <div class="wgbl-table">
            ...
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 gifts', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table wgbl-mini-data-grid-box">
                    <div class="wgbl-table">
        ...
        <div class="wgbl-row">
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 categories', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table wgbl-mini-data-grid-box">
                    <div class="wgbl-table">
            ...
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 countries', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table wgbl-mini-data-grid-box">
                    <div class="wgbl-table">
            ...
            <div class="wgbl-col-4">
                <div class="wgbl-col-12">
                    <strong class="wgbl-section-title"><?php esc_html_e('Top 5 states', 'ithemeland-free-gifts-for-woo'); ?></strong>
                </div>
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table wgbl-mini-data-grid-box">
                    <div class="wgbl-table">
        ...
        <div class="wgbl-row">
            <div class="wgbl-col-12">
                <strong class="wgbl-section-title"><?php esc_html_e('Recent 10 customers get gift', 'ithemeland-free-gifts-for-woo'); ?></strong>
            </div>
            <div class="wgbl-col-12">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table">
                    <div class="wgbl-table table-responsive">
        ...
        <div class="wgbl-row">
            <div class="wgbl-col-12">
                <strong class="wgbl-section-title"><?php esc_html_e('Recent 10 Used gifts', 'ithemeland-free-gifts-for-woo'); ?></strong>
            </div>
            <div class="wgbl-col-12">
                <div class="wgbl-widget-box wgbl-skeleton-loading wgbl-skeleton-table">
                    <div class="wgbl-table table-responsive">
