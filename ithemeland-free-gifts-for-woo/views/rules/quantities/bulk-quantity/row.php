    ...
    <div class="wgbl-rule-quantities-bulk-quantity-repeatable-item">
        <div class="wgbl-col-1-5" style="padding: 0; margin: 2px 0 0 0;">
            <div class="wgbl-form-group">
                <button type="button" class="wgbl-rule-item-quantities-bulk-quantity-row-sortable-btn wgbl-button-tr wgbl-float-left"><i class="dashicons dashicons-menu"></i></button>
            </div>
        </div>
        ...
        <div class="wgbl-col-1-5">
            <div class="wgbl-form-group">
                <button type="button" class="wgbl-rules-quantities-bulk-quantity-delete-row-item wgbl-button-tr wgbl-float-right"><i class="dashicons dashicons-no-alt"></i></button>
            </div>
        </div>
    </div>
<?php endif; ?>