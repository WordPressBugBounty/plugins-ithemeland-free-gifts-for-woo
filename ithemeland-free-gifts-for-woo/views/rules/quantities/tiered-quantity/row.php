...
<?php if (isset($rule_id)) : ?>
    <div class="wgb-rule-quantities-tiered-quantity-repeatable-item">
        <div class="wgb-col-1-5" style="padding: 0; margin: 2px 0 0 0;">
            <div class="wgb-form-group">
                <button type="button" class="wgb-rule-item-quantities-tiered-quantity-row-sortable-btn wgb-button-tr wgb-float-left"><i class="dashicons dashicons-menu"></i></button>
            </div>
        </div>
        ...
        <div class="wgb-col-1-5">
            <div class="wgb-form-group">
                <button type="button" class="wgb-rules-quantities-tiered-quantity-delete-row-item wgb-button-tr wgb-float-right"><i class="dashicons dashicons-no-alt"></i></button>
            </div>
        </div>
    </div>
<?php endif; ?>