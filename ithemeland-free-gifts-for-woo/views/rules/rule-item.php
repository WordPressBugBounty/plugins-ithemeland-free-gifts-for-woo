...
<div class="wgbl-rule-item <?php echo (!empty($rule_item['status']) && $rule_item['status'] == 'disable') ? 'wgbl-rule-disable' : 'wgbl-rule-enable'; ?>" data-id="<?php echo esc_attr($rule_id); ?>">
    ...
    <div class="wgbl-rule-header">
        <div class="wgbl-float-left">
            ...
            <h4 class="wgbl-rule-method-name"><?php echo (!empty($rule_methods[$rule_item['method']])) ? esc_html($rule_methods[$rule_item['method']]) : esc_html__('Unknown method', 'ithemeland-free-gifts-for-woo'); ?></h4>
                ...
                <div class="wgbl-form-group">
                    ...
                    <select name="rule[<?php echo esc_attr($rule_id); ?>][quantities_based_on]">
                        <optgroup label="Individual Products">
                            ...
                            <option value="each_individual_variation" <?php echo (!empty($rule_item['quantities_based_on']) && $rule_item['quantities_based_on'] == 'each_individual_variation') ? 'selected' : ''; ?>><?php esc_html_e('Each individual variation - Pro version', 'ithemeland-free-gifts-for-woo'); ?></option>
                            <option value="each_individual_cart_line_item" <?php echo (!empty($rule_item['quantities_based_on']) && $rule_item['quantities_based_on'] == 'each_individual_cart_line_item') ? 'selected' : ''; ?>><?php esc_html_e('Each individual cart line item - Pro version', 'ithemeland-free-gifts-for-woo'); ?></option>
                        </optgroup>
                        <optgroup label="All Matched Products">
                            <option value="quantities_added_up_by_category" <?php echo (!empty($rule_item['quantities_based_on']) && $rule_item['quantities_based_on'] == 'quantities_added_up_by_category') ? 'selected' : ''; ?>><?php esc_html_e('Quantities added up by category - Pro version', 'ithemeland-free-gifts-for-woo'); ?></option>
                            <option value="all_quantities_added_up" <?php echo (!empty($rule_item['quantities_based_on']) && $rule_item['quantities_based_on'] == 'all_quantities_added_up') ? 'selected' : ''; ?>><?php esc_html_e('All quantities added up - Pro version', 'ithemeland-free-gifts-for-woo'); ?></option>
                        </optgroup>
                    </select>
                </div>
            </div>
            ...
            <div class="wgbl-col-12" data-type="quantities">
                <div class="wgbl-rule-section">
                        ...
                        <div class="wgbl-col-2-5 wgbl-quantity-item" data-type="quantities-apply-on-cart-item" style="display: <?php echo ($rule_item['method'] == 'cheapest_item_in_cart') ? 'block' : 'none'; ?>">
                            <!--<div class="wgbl-form-group wgbl-checkbox-group">
                                <label>
                                    ...
                                    <?php esc_html_e("Apply on the same cart line item", 'ithemeland-free-gifts-for-woo'); ?>
                                </label>
                    ...
                    <div class="wgbl-rule-section-content" data-method-type="bulk_quantity" style="display: <?php echo ($rule_item['method'] == 'bulk_quantity') ? 'block' : 'none'; ?>">
                        ...
                        <div class="wgbl-col-6" style="padding-left: 48px;">
                            <div class="wgbl-col-6 wgbl-quantity-item" data-type="quantities-same-gift">
                                <div class="wgbl-form-group wgbl-checkbox-group">
                                    <label><input type="checkbox" data-id="<?php echo esc_attr($rule_id); ?>" data-name="same_gift" class="wgbl-rule-quantities-checkbox" <?php echo (!empty($rule_item['quantity']['same_gift']) && $rule_item['quantity']['same_gift'] == 'yes') ? 'checked="checked"' : ''; ?>> <?php esc_html_e('Same Gift', 'ithemeland-free-gifts-for-woo'); ?></label>
                        ...
                        <div class="wgbl-col-6" style="padding-right: 49px;">
                            <button type="button" class="wgbl-float-right wgbl-button wgbl-button-white-green wgbl-bulk-quantity-quantities-add-item"><?php esc_html_e('Add item', 'ithemeland-free-gifts-for-woo'); ?></button>
                        </div>
                    </div>
                    <div class="wgbl-rule-section-content" data-method-type="bulk_pricing" style="display: <?php echo ($rule_item['method'] == 'bulk_pricing') ? 'block' : 'none'; ?>">
                        ...
                        <div class="wgbl-col-6" style="padding-right: 49px;">
                            <button type="button" class="wgbl-float-right wgbl-button wgbl-button-white-green wgbl-bulk-pricing-quantities-add-item"><?php esc_html_e('Add item', 'ithemeland-free-gifts-for-woo'); ?></button>
                        </div>
                    </div>
            ...
            <div class="wgbl-col-12" data-type="product-buy" style="<?php echo (in_array($rule_item['method'], ['simple', 'subtotal', 'subtotal_repeat'])) ? 'display: none;' : ''; ?>">
                <div class="wgbl-rule-section">
                    ...
                    <div class="wgbl-rule-section-content">
                        ...
                        <button type="button" class="wgbl-float-right wgbl-button wgbl-button-white-green wgbl-product-buy-add-product"><?php esc_html_e('Add Product', 'ithemeland-free-gifts-for-woo'); ?></button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="wgbl-rule-section-content">
                        <div class="wgbl-col-12">
                            <div class="wgbl-form-group">
                                ...
                                <select name="rule[<?php echo esc_attr($rule_id); ?>][include_products][]" class="wgbl-select2-products-variations wgbl-select2-option-values" data-option-name="products" data-type="select2" multiple data-placeholder="<?php esc_html_e('Select ...', 'ithemeland-free-gifts-for-woo'); ?>" <?php echo (in_array($rule_item['method'], ['buy_x_get_x', 'buy_x_get_x_repeat'])) ? 'disabled' : ''; ?>>
                                    <?php
                        ...
                        <div class="wgbl-col-6">
                            <div class="wgbl-form-group">
                                ...
                                <select name="rule[<?php echo esc_attr($rule_id); ?>][exclude_products][]" class="wgbl-select2-products-variations wgbl-select2-option-values" data-option-name="products" data-type="select2" multiple data-placeholder="<?php esc_html_e('Select ...', 'ithemeland-free-gifts-for-woo'); ?>" <?php echo (in_array($rule_item['method'], ['buy_x_get_x', 'buy_x_get_x_repeat'])) ? 'disabled' : ''; ?>>
                                    <?php
            ...
            <div class="wgbl-col-12" data-type="conditions">
                <div class="wgbl-rule-section">
                    ...
                    <div class="wgbl-rule-section-content">
                        ...
                        <button type="button" class="wgbl-float-right wgbl-button wgbl-button-white-green wgbl-add-condition"><?php esc_html_e('Add Condition', 'ithemeland-free-gifts-for-woo'); ?></button>
                    </div>
                </div>
            </div>
        </div>
