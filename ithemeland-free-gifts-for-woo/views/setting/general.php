        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
            ...
            <div id="wgbl-settings" class="wgbl-col-12">
                <div class="wgbl-form-group">
                    <label for="wgbl-settings-dashboard_date-in-cart"><?php esc_html_e('Dashboard date', 'ithemeland-free-gifts-for-woo'); ?></label>
                    ...
                    <p class="wgbl-description"><?php esc_html_e('Set date for dashboard report', 'ithemeland-free-gifts-for-woo'); ?></p>
                </div>
                <div class="wgbl-form-group">
                    <label for="wgbl-settings-display_price-in-cart"><?php esc_html_e('Display price for gift', 'ithemeland-free-gifts-for-woo'); ?></label>
                    ...
                    <p class="wgbl-description"><?php esc_html_e('Display price for gifts are added to cart', 'ithemeland-free-gifts-for-woo'); ?></p>
                </div>
                <div class="wgbl-form-group">
                    <label for="wgbl-settings-position-in-cart"><?php esc_html_e("'Your Gifts' position", 'ithemeland-free-gifts-for-woo'); ?></label>
                    <select name="settings[position]" id="wgbl-settings-position-in-cart">
                        ...
                        <option value="bottom_cart" <?php echo (!empty($settings['position']) && $settings['position'] == 'bottom_cart') ? 'selected' : '' ?>>
                            <?php esc_html_e('Bottom of Cart', 'ithemeland-free-gifts-for-woo'); ?>
                        </option>
                    ...
                    <p class="wgbl-description"><?php esc_html_e("Where do you want to display available gift in cart page?", 'ithemeland-free-gifts-for-woo'); ?></p>
                </div>
                <div class="wgbl-form-group" data-type="layout-select-box">
                    <label for="wgbl-settings-layout"><?php esc_html_e('Layout', 'ithemeland-free-gifts-for-woo'); ?></label>
                ...
                <div class="wgbl-form-group position-dependency" data-type="bottom_cart">
                    <label for="wgbl-settings-show-variations"><?php esc_html_e('Show Variations', 'ithemeland-free-gifts-for-woo'); ?></label>
                    ...
                    <p class="wgbl-description"><?php esc_html_e('Leave it if you want to show variations gifts in popup', 'ithemeland-free-gifts-for-woo'); ?></p>
                </div>
                <div class="wgbl-form-group position-dependency" data-type="bottom_cart">
                    <label for="wgbl-settings-show-stock-quantity"><?php esc_html_e('Show Stock Quantity', 'ithemeland-free-gifts-for-woo'); ?></label>
                    ...
                    <p class="wgbl-description"><?php esc_html_e("If checked, 'stock status' is shown for each gift.", 'ithemeland-free-gifts-for-woo'); ?></p>
                </div>
                <div id="wgbl-settings-view-gift-in-cart-dependencies">
                    <div class="wgbl-settings-dependency-item" data-type="grid">
                        <div class="wgbl-form-group">
                            ...
                            <input type="number" placeholder="<?php esc_html_e('Gift Number Per Page', 'ithemeland-free-gifts-for-woo'); ?> ..." min="1" name="settings[view_gift_in_cart][number_per_page]" value="<?php echo (isset($settings['view_gift_in_cart']['number_per_page'])) ? esc_attr($settings['view_gift_in_cart']['number_per_page']) : '4' ?>">
                        </div>
                        <div class="wgbl-form-group">
                    ...
                    <div class="wgbl-settings-dependency-item" data-type="carousel">
                        <div class="wgbl-form-group">
                            <label for="wgbl-settings-carousel-loop"><?php esc_html_e('Loop', 'ithemeland-free-gifts-for-woo'); ?></label>
                        ...
                        <div class="wgbl-form-group">
                            <label for="wgbl-settings-carousel-dots"><?php esc_html_e('Show Dots', 'ithemeland-free-gifts-for-woo'); ?></label>
                        ...
                        <div class="wgbl-form-group">
                            <label for="wgbl-settings-carousel-nav"><?php esc_html_e('Show Nav', 'ithemeland-free-gifts-for-woo'); ?></label>
                        ...
                        <div class="wgbl-form-group">
                            ...
                            <input type="number" placeholder="<?php esc_html_e('Slide Speed', 'ithemeland-free-gifts-for-woo'); ?> ..." name="settings[view_gift_in_cart][carousel][speed]" value="<?php echo (isset($settings['view_gift_in_cart']['carousel']['speed'])) ? esc_attr($settings['view_gift_in_cart']['carousel']['speed']) : '5000'; ?>">
                        </div>
                        <div class="wgbl-form-group">
                            <label><?php esc_html_e('Number Items in Mobile', 'ithemeland-free-gifts-for-woo'); ?></label>
                            <input type="number" placeholder="<?php esc_html_e('Number Items', 'ithemeland-free-gifts-for-woo'); ?> ..." name="settings[view_gift_in_cart][carousel][mobile]" value="<?php echo (isset($settings['view_gift_in_cart']['carousel']['mobile'])) ? esc_attr($settings['view_gift_in_cart']['carousel']['mobile']) : '1' ?>">
                        </div>
                        <div class="wgbl-form-group">
                            <label><?php esc_html_e('Number Items in Tablet', 'ithemeland-free-gifts-for-woo'); ?></label>
                            <input type="number" placeholder="<?php esc_html_e('Number Items', 'ithemeland-free-gifts-for-woo'); ?> ..." name="settings[view_gift_in_cart][carousel][tablet]" value="<?php echo (isset($settings['view_gift_in_cart']['carousel']['tablet'])) ? esc_attr($settings['view_gift_in_cart']['carousel']['tablet']) : '3' ?>">
                        </div>
                        <div class="wgbl-form-group">
                            <label><?php esc_html_e('Number Items in Desktop', 'ithemeland-free-gifts-for-woo'); ?></label>
                            <input type="number" placeholder="<?php esc_html_e('Number Items', 'ithemeland-free-gifts-for-woo'); ?> ..." name="settings[view_gift_in_cart][carousel][desktop]" value="<?php echo (isset($settings['view_gift_in_cart']['carousel']['desktop'])) ? esc_attr($settings['view_gift_in_cart']['carousel']['desktop']) : '5' ?>">
                        </div>
                    </div>
                </div>
                <div class="wgbl-form-group">
                    <input type="hidden" name="settings[enable_ajax_add_to_cart]" value="false">
                    <label for="wgbl-settings-enable-ajax-add-to-cart"><?php esc_html_e('Ajax Manual Gift Products Add To Cart', 'ithemeland-free-gifts-for-woo'); ?></label>
            ...
            <div class="wgbl-col-12">
                <button type="submit" class="wgbl-button wgbl-button-blue wgbl-float-left wgbl-mt10"><?php esc_html_e("Save Changes", 'ithemeland-free-gifts-for-woo'); ?></button>
            </div>
        </form>
    </div>
</div>