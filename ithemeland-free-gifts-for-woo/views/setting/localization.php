        ...
        <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="POST">
            ...
            <div id="wgbl-settings" class="wgbl-col-12">
                <div class="wgbl-form-group">
                    ...
                    <input type="text" placeholder="<?php esc_html_e('Free', 'ithemeland-free-gifts-for-woo'); ?> ..." name="localization[txt_free]" value="<?php echo (isset($localization['itg_localization_txt_free'])) ? esc_attr($localization['itg_localization_txt_free']) : 'Free' ?>">
                </div>
                <div class="wgbl-form-group">
                ...
                <div class="wgbl-form-group">
                    <label><?php esc_html_e('Select Your Gift ( Dropdown Layout )', 'ithemeland-free-gifts-for-woo'); ?></label>
                    <input type="text" placeholder="<?php esc_html_e('Select Your Gift', 'ithemeland-free-gifts-for-woo'); ?> ..." name="localization[select_your_gift]" value="<?php echo (isset($localization['itg_localization_select_your_gift'])) ? esc_attr($localization['itg_localization_select_your_gift']) : 'Select Your Gift' ?>">
                </div>
                <div class="wgbl-form-group">
